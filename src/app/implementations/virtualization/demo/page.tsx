...
const generateItems = (count: number) => {
  return Array.from({ length: count }, (_, i) => ({
    id: i,
    name: `Item ${i + 1}`,
    description: `This is the description for item ${i + 1}. It contains some sample text to make the list more realistic.`,
...
function VirtualList({ items, height = 400 }: { items: any[]; height?: number }) {
  const [scrollTop, setScrollTop] = useState(0);
  const itemHeight = 80;
  
  const { visibleItems, totalHeight, offsetY, startIndex, endIndex } = useVirtualization({
    items,
    itemHeight,
    ...
    <div className="bg-white dark:bg-gray-950 rounded-lg border border-gray-200 dark:border-gray-800 overflow-hidden">
      <div className="p-4 border-b border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900">
        <div className="flex justify-between items-center text-sm text-gray-600 dark:text-gray-400">
          <span>Showing items {startIndex + 1}-{endIndex + 1} of {items.length}</span>
          <span>Rendered: {visibleItems.length} / Total: {items.length}</span>
        </div>
      </div>
        ...
        {showAll ? (
          <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-3">
            <p className="text-red-800 dark:text-red-300">
              ⚠️ Rendering all 1,000 items in DOM. This may cause performance issues!
            </p>
          </div>
        ) : (
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mb-8">
              Experience the power of virtualization with large datasets. Only visible items are rendered in the DOM, 
              ensuring smooth performance even with thousands of items.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
            <div className="bg-white dark:bg-gray-950 rounded-lg border border-gray-200 dark:border-gray-800 p-6 text-center">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Maintains 60fps even with 100,000+ items by only rendering visible elements
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-950 rounded-lg border border-gray-200 dark:border-gray-800 p-6 text-center">
              ...
              <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">Memory Efficient</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Reduces DOM nodes from thousands to just a handful, minimizing memory usage
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-950 rounded-lg border border-gray-200 dark:border-gray-800 p-6 text-center">
              <div className="w-12 h-12 bg-purple-100 dark:bg-purple-900 rounded-lg flex items-center justify-center mx-auto mb-4">
                <svg className="w-6 h-6 text-purple-600 dark:text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 4V2a1 1 0 011-1h8a1 1 0 011 1v2M7 4h10l2 2v13a2 2 0 01-2 2H7a2 2 0 01-2-2V6l2-2z" />
                </svg>
              </div>
          ...
          <div className="bg-white dark:bg-gray-950 rounded-lg border border-gray-200 dark:border-gray-800 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <h4 className="font-medium text-gray-900 dark:text-gray-100 mb-2">1. Calculate Visible Range</h4>
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                  Based on scroll position and container height, determine which items should be visible.
                </p>
                
                <h4 className="font-medium text-gray-900 dark:text-gray-100 mb-2">2. Render Only Visible Items</h4>
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Create DOM elements only for items currently in the viewport plus a small buffer.
                </p>
              </div>
              <div>
                <h4 className="font-medium text-gray-900 dark:text-gray-100 mb-2">3. Handle Scrolling</h4>
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                  Update visible range as user scrolls and efficiently re-render new items.
                </p>
                
                <h4 className="font-medium text-gray-900 dark:text-gray-100 mb-2">4. Maintain Scroll Position</h4>
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Use absolute positioning to maintain proper scroll behavior and spacing.
                </p>
              </div>
            </div>
          </div>
