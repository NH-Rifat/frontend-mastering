...
import { quickLinks, resources, socialLinks } from '@/data/navigation';
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            >
              ...
              <p className="text-gray-300 mb-6 max-w-md leading-relaxed">
                Master modern frontend development with interactive examples,
                production-ready code, and comprehensive guides. Everything you
                need to become a frontend expert.
              </p>
          ...
          >
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              <div className="text-gray-400 text-sm">
                © {new Date().getFullYear()} Frontend Mastering. Made with ❤️
