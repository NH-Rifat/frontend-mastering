              ...
              >
                {item.external ? (
                  ...
                  >
                    ...
                    {/* External link icon */}
                    <svg className="inline-block ml-1 w-3 h-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
